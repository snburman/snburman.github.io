...
```
[fncmp.HandleFn](https://pkg.go.dev/github.com/kitkitchen/fncmp#HandleFn) accepts a context.Context and returns a FnComponent.
:::warning
...
```
[fncmp.FnComponent](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent) is instantiated with a context.Context and a [fncmp.Component](https://pkg.go.dev/github.com/kitkitchen/fncmp#Component). 
...
Parameter: <b>tag</b> <i>string</i>
    <ul style={{justifyContent: 'flex-end'}}>
        <li>[SwapTagInner](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent.SwapTagInner) (default)</li>
        Swaps the inner HTML of a tag (eg. main) with the HTML rendered by the FnComponent
        <li>[SwapTagOuter](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent.SwapTagOuter)</li>
        Swaps the outer HTML of a tag with the HTML rendered by the FnComponent
        <li>[PrependTag](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent.PrependTag)</li>
        Prepends the HTML of a tag with the HTML rendered by the FnComponent
        <li>[AppendTag](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent.AppendTag)</li>
...
Parameter: <b>id</b> <i>string</i>
    <ul style={{justifyContent: 'flex-start'}}>
        <li>[SwapElementInner](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent.SwapElementInner)</li>
        Swaps the inner HTML of an element by ID with the HTML rendered by the FnComponent
        <li>[SwapElementOuter](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent.SwapElementOuter)</li>
        Swaps the outer HTML of an element by ID with the HTML rendered by the FnComponent
        <li>[PrependElement](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent.PrependElement)</li>
        Prepends the HTML of an element by ID with the HTML rendered by the FnComponent
        <li>[AppendElement](https://pkg.go.dev/github.com/kitkitchen/fncmp#FnComponent.AppendElement)</li>
